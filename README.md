...
Ez a projekt gyümölcs érkezését nyilvántartó alkalmazás, amely adatbázisban tárolja a gyümölcsök nevét, mennyiségét és egységárát. Az alkalmazás lehetővé teszi a gyümölcsök listázását, új gyümölcs hozzáadását, meglévő gyümölcs adatainak módosítását és gyümölcs törlését. A backend REST API végpontokat biztosít a frontend számára, amely egy felhasználóbarát felületen keresztül jeleníti meg az adatokat és kezeli a műveleteket. 
...
Törlés gomb a felesleges bejegyzések eltávolítás 
